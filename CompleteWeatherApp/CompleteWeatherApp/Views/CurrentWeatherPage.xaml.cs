...
namespace CompleteWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private double Latidude { get; set; }
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=c544a131fac437a24072d6cda8547030&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=c544a131fac437a24072d6cda8547030&units=metric";
            var result = await ApiCaller.Get(url);
